...
const PACKAGES = {
  ...
  elite: {
    ...
    description:
      "Launch your U.S. business with a complete setup package including LLC, EIN, ITIN, and a U.S. Business Address, plus 12 months of personalized coaching to help you build credit, stay compliant, and grow your financial power in the United States. Interested in learning more? Schedule a free consultation call with our team.",
...
function listPackages() {
  return Object.values(PACKAGES).map((pkg) => ({
    ...
    consultationOnly: Boolean(pkg.consultationOnly),
